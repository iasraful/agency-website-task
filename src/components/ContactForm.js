        ...
        <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
          ...
          <form className="space-y-8">
            <div>
              <label
                htmlFor="email"
                className="flex self-center  mb-2 text-sm font-medium text-gray-900 "
              >
                Your email
              </label>
              <input
            ...
            <div>
              <label
                htmlFor="subject"
                className="flex self-center  mb-2 text-sm font-medium text-gray-900 dark:text-gray-300"
              >
                Subject
              </label>
              <input
            ...
            <div className="sm:col-span-2">
              <label
                htmlFor="message"
                className="flex self-center mb-2 text-sm font-medium text-gray-900 dark:text-gray-400"
              >
                Your message
              </label>
              <textarea
          ...
          <button
            onClick={() => sendMail()}
            className="py-3 px-5 m-10 text-sm font-medium text-center text-black rounded-lg bg-stone-300  sm:w-fit hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 "
          >
            Send message
          </button>
          <button
